...
namespace Photon.Pun
{
    ...
    public class PhotonTransformViewClassic : MonoBehaviourPun, IPunObservable
    {
        ...
        public void SetSynchronizedValues(Vector3 speed, ProtectedFloat turnSpeed)
        {
    ...
    public class PhotonTransformViewPositionModel
    {
        ...
        public ProtectedFloat TeleportIfDistanceGreaterThan = 3f;

        public InterpolateOptions InterpolateOption = InterpolateOptions.EstimatedSpeed;
        public ProtectedFloat InterpolateMoveTowardsSpeed = 1f;

        public ProtectedFloat InterpolateLerpSpeed = 1f;

        public ExtrapolateOptions ExtrapolateOption = ExtrapolateOptions.Disabled;
        public ProtectedFloat ExtrapolateSpeed = 1f;
    ...
    public class PhotonTransformViewPositionControl
    {
        ...
        ProtectedFloat m_CurrentSpeed;
        double m_LastSerializeTime;
        Vector3 m_SynchronizedSpeed = Vector3.zero;
        ProtectedFloat m_SynchronizedTurnSpeed = 0;
        ...
        public Vector3 UpdatePosition(Vector3 currentPosition)
        {
            ...
            switch (m_Model.InterpolateOption)
            {
                ...
                case PhotonTransformViewPositionModel.InterpolateOptions.EstimatedSpeed:
                    ...
                    ProtectedFloat estimatedSpeed = (Vector3.Distance(m_NetworkPosition, GetOldestStoredNetworkPosition()) / m_OldNetworkPositions.Count) * PhotonNetwork.SerializationRate;
        ...
        {
            ProtectedFloat timePassed = (float)(PhotonNetwork.Time - m_LastSerializeTime);
    ...
    public class PhotonTransformViewRotationModel
    {
        ...
        public ProtectedFloat InterpolateRotateTowardsSpeed = 180;
        public ProtectedFloat InterpolateLerpSpeed = 5;
    }
    ...
    public class PhotonTransformViewScaleModel
    {
        ...
        public ProtectedFloat InterpolateMoveTowardsSpeed = 1f;
        public ProtectedFloat InterpolateLerpSpeed;
    }
